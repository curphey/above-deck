...
4. **One cohesive UI.** OpenPlotter = Frankenstein. d3kOS = vanilla JS with global state. Above Deck's blueprint aesthetic with Astro + React + Mantine is the right approach.
